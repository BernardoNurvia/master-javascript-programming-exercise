...
test ('Testing with (8, 12) and it should return false', () => {
    expect(areBothOdd(8, 12)).toBe(false);
})

test ('Testing with (7, 11) and it should return true', () => {
    expect(areBothOdd(7, 11)).toBe(true);

})

test ('Testing with (3, 5) and it should return true', () => {
    expect(areBothOdd(3, 5)).toBe(true);

})

test ('Testing with (7, 4) and it should return false', () => {
    expect(areBothOdd(7, 4)).toBe(false);

})

test ('Testing with (6, 11) and it should return false', () => {
