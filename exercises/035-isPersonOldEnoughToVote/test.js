...
test ('Function should return false if age is less than 18. Testing with 17', () => {
   
    expect(isPersonOldEnoughToVote({ age: 17 })).toBe(false);
})
test ('Function should return false if age less than 18. Testing with 5', () => {
   
    expect(isPersonOldEnoughToVote({ age: 5 })).toBe(false);
})
test ('Function should return true if age is greater than or equal to 18. Testing with 18', () => {
  
    expect(isPersonOldEnoughToVote({ age: 18 })).toBe(true);

})
test ('Function should return true if age is greater than or equal to 18. Testing with 20', () => {
