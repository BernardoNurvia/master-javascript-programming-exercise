...
test('Function must return the perimeter of a triangle. Testing with 4, 6 and 10', () => {
    let output = computePerimeterOfATriangle(6, 4, 10)
    expect(output).toBe(20)
})
test('Function must return the perimeter of a triangle. Testing with 5, 10 and 10', () => {
    let output = computePerimeterOfATriangle(10, 5, 10)
    expect(output).toBe(25)
})
test('Function must return the perimeter of a triangle. Testing with 1, 3 and 5', () => {
