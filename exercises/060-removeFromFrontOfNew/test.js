...
test('Function must return a new array containing all elements, except the first. Testing with [9,21,74,33]', () => {
...
test('Function must return a new array containing all elements, except the first. Testing with [1,2,3]', () => {
    let input = [1, 2, 3]
    let output = removeFromFrontOfNew(input)
