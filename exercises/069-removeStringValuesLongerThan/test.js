...
test('The function must eliminate the properties whose values are strings longer than the given number', () => {
  let obj = {
    name: 'Tea',
    price: 5,
    location: 'Colombia',
...
test('The function must eliminate the properties whose values are strings longer than the given number. Testing with different values', () => {
  const removeStringValuesLongerThan = rewire('./app.js').__get__(
    'removeStringValuesLongerThan'
  );
  let obj = {
