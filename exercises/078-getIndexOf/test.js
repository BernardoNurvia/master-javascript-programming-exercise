...
test('The function must return the first position (index) of the given character in the given string', () => {
  let output = getIndexOf('a', 'I am a hacker');
  expect(output).toBe(2);
});

test('The function must return the first position (index) of the given character in the given string. Testing with different values', () => {
