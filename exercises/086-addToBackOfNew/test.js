...
test('The returned array should have the new element as the last element of the array', () => {
  expect(addToBackOfNew([1, 2], 3)).toEqual([1, 2, 3]);
});

test('The returned array should have the new element as the last element of the array. Testing with different values', () => {
