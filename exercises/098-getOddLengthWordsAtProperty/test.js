...
test('The function must return only the odd elements on a given key. Testing with different values', () => {
  let obj = {
...
test('If the property at the given key is not an array, it should return an empty array. Testing with different values', () => {
  let obj = {
    key: {},
  };
  let output = getOddLengthWordsAtProperty(obj, 'key');
