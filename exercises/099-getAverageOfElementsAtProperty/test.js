...
test('If the property at the given key is not an array, it should return 0. Testing with different values', () => {
  let obj = {
    key: {},
  };
  let output = getAverageOfElementsAtProperty(obj, 'key');
...
test('Function returns the average of array elements', () => {
  let obj = {
    key: [4, 8, 6],
  };
  let output = getAverageOfElementsAtProperty(obj, 'key');
...
test('Function returns the average of array elements. Testing with different values', () => {
  let obj = {
    key: [10, 9, 7],
  };
  let output = getAverageOfElementsAtProperty(obj, 'key');
