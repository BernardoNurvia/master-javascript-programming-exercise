...
test('Function must return an array containing only the odd numbers of the given array', () => {
  expect(filterOddElements([3, 9, 12, 37])).toEqual([3, 9, 37]);
});

test('Function must return an array containing only the odd numbers of the given array. Testing with different values', () => {
